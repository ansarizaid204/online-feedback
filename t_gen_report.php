...
include('db/dbh.php') ;
    ...
    if (isset($_POST['gen_btn'])) {
        ...
        $c_id=$row2['c_id'];
            ...
            if ($c_id==1) {
                header("location:t_xyz.php");
            }
            elseif ($c_id==2) {
                header("location:t_xyz1.php");
            }
            elseif ($c_id==3) {
                header("location:t_xyz1.php");
            }
            elseif ($c_id==4) {
                header("location:t_xyz_prac.php");
            }
    }
...
<div class="content">
    ...
    <button type="submit" name="login-btn"  
     class="btn-login1"><a href="teacher_home.php" style="text-decoration:none;color: white;">Back</a></button>
     <br><br>
...
<form  method="POST" name="form" action="t_gen_report.php" onsubmit="return validate(this);">
<table>
