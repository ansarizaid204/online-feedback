...
<div class="content">
    ...
    <div class="content5">
        ...
        <form action="teacher_sel.php" method="POST" name="form" onsubmit="return validate(this);">
    ...
    ?>
            ...
            <button type="submit" name="tselect-btn" class="btn-login2" id="btn_1">view</button>
