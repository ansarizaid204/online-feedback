...
<?php  
    ...
    if (isset($_POST['register-btn'])) {
        ...
        $sql="INSERT INTO teacher(t_name,dept_id,shift) VALUES('$name','$dept_id','$shift')";
...
<div class="content">
    ...
    <div class="content4">
        ...
        <form action="add_teacher.php" method="POST" name="form" onsubmit="return validate(this);">
<table>
    <tr>
        <td>Name</td>
        <td><input type="text" name="t_name" placeholder="Name" class="textinput1" required autofocus></td>
    </tr>
