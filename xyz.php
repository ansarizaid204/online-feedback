...
<table border="1" cellspacing="2" cellpadding=4>
    <tbody>
        <tr>
            <td>&nbsp;Faculty Name&nbsp;</td>
            <td colspan="6"><?php echo $t_name ?>&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;Department</td>
            <td colspan="6">&nbsp;</td>
        ...
        <tr>
            <td>Subject</td>
            <td colspan="6"><?php echo $sub_name ?>&nbsp;</td>
        </tr>
        <tr >
...
<td<?php if($f_rate10 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate10>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate10 ?>% </td>
        ...
        <tr>
            <th  colspan="5">overall performance</th>
           <td colspan="2"<?php if($f_avg <60): ?> style="background-color:#E57373;" <?php elseif($f_avg>=90): ?> style="background-color:#81C784;"<?php endif; ?>><h3><?php echo $f_avg ?>% </td>
        </tr>
    </tbody>
</table>
-->
