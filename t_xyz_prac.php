...
<div class="content">
    ...
    <button type="submit" name="login-btn"  
     class="btn-login1"><a href="t_gen_report.php" style="text-decoration:none;color: white;">Back</a></button>
     <br><br>
...
$avg=$f_rate1+$f_rate2+$f_rate3+$f_rate4+$f_rate6+$f_rate7+$f_rate8+$f_rate10;
$f_avg=$avg/8;
