...
<div class="content">
    ...
    <button type="submit" name="login-btn"  
     class="btn-login1"><a href="subject.php" style="text-decoration:none;color: white;">Back</a></button>
     <br><br>
...
<table>
    ...
    <tr>
        <td>Subject Name</td>
        <td><input type="text" name="name" placeholder="Subject Name" class="textinput1" required autofocus value="<?php echo $record['sub_name']; ?>"></td>
    </tr>
