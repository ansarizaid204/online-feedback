...
$sql3="INSERT INTO rating(sub_id,t_id,r_1,r_2,r_3,r_4,r_5,r_6,r_7,r_8,r_9,r_10,flag,id) VALUES('$sub_id','$s_techer','$r1','$r2','$r3','$r4','$r5','$r6','$r7','$r8','$r9','$r10','$flag','$id')";
...
<br><br>
<span>E. Were the msbte question paper were discussed<br><br></span>
<table border="0" cellspacing="0" cellpadding=10>
<tr>
<div class="radio">
    <td colspan=2 align=left><input type=radio name="E" value="3" checked> Excellent </td>
    <td colspan=2 align=left><input type=radio name="E" value="2"> V. Good </td>
    <td colspan=2 align=left><input type=radio name="E" value="1"> Good </td>
    <td colspan=2 align=left><input type=radio name="E" value="0"> Fair </td>
</div>
...
<br><br>
<span>I. Guide for extra curricular activities(Paper presentation/innovative technique)<br><br></span>
<table border="0" cellspacing="0" cellpadding=10>
<tr>
<div class="radio">
    <td colspan=2 align=left><input type=radio name="I" value="3" checked> Always </td>
    <td colspan=2 align=left><input type=radio name="I" value="2"> Mostly </td>
    <td colspan=2 align=left><input type=radio name="I" value="1"> Sometimes </td>
    <td colspan=2 align=left><input type=radio name="I" value="0"> Never </td>
</div>
