...
if (isset($_SESSION['teacher_loggedin']) && $_SESSION['teacher_loggedin'] == true) {
    if (empty($_SESSION['sub_id'])) {
        header("location:t_gen_report.php");
    }
    ?>
...
<div class="content">
    ...
    <button type="submit" name="login-btn"  
     class="btn-login1" onclick="printContent('content3')">Print</button>
     <br><br>
...
while($row1=mysqli_fetch_assoc($result1)){
    ...
    $rate5=$rate5 + $row1['r_5'];   
    $rate6=$rate6 + $row1['r_6'];   
    $rate7=$rate7 + $row1['r_7'];   
    $rate8=$rate8 + $row1['r_8'];
...
$f_rate5=(($rate5/$numrec1)*100)/4;
$f_rate6=(($rate6/$numrec1)*100)/4;
$f_rate7=(($rate7/$numrec1)*100)/4;
$f_rate8=(($rate8/$numrec1)*100)/4;
$f_rate9=(($rate9/$numrec1)*100)/4;
$f_rate10=(($rate10/$numrec1)*100)/4;
$avg=$f_rate1+$f_rate2+$f_rate3+$f_rate4+$f_rate5+$f_rate6+$f_rate7+$f_rate8+$f_rate9+$f_rate10;
$f_avg=$avg/10;
...
<td  <?php if($f_rate1 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate1>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate1 ?>% </td>
</tr>
<tr >
<td>B. Was the topic fully covered illustrated with example</td>
<td<?php if($f_rate2 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate2>=90): ?> style="background-color:#81C784;" <?php endif; ?>><?php echo $f_rate2 ?>% </td>
</tr>
<tr>
<TD>C. Commumnication and effective  ness in delivery of lecturer?</td>
<td<?php if($f_rate3 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate3>=90): ?> style="background-color:#81C784;" <?php endif; ?>> <?php echo $f_rate3 ?>% </td>
</tr>
<tr>
<TD>D. Were the doubts/query and problems were solved</td>
<td<?php if($f_rate4 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate4>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate4 ?>% </td>
</tr>
<tr>
...
<td<?php if($f_rate6 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate6>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate6 ?>% </td>
</tr>
<tr>
<TD>G. makes effective use of variety of available material and resources(projectors,board,sincere)</td>
<td<?php if($f_rate7 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate7>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate7 ?>% </td>
</tr>
...
<td<?php if($f_rate9 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate9>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate9 ?>% </td>
</tr>
<tr >
<TD>J. Maintain student interest and attention</td>
<td<?php if($f_rate10 <60): ?> style="background-color:#E57373;" <?php elseif($f_rate10>=90): ?> style="background-color:#81C784;"<?php endif; ?>> <?php echo $f_rate10 ?>% </td>
</tr>


<tr >
<td><h3>OverAll Percentage</td>
<td<?php if($f_avg <60): ?> style="background-color:#E57373;" <?php elseif($f_avg>=90): ?> style="background-color:#81C784;"<?php endif; ?>><h3><?php echo $f_avg ?>% </td>
</tr>
...
<button  class="btn-login" style="margin-left: 20px;"><a href="teacher_login.php" style="text-decoration:none;color: white;">Login</a></button>
</div>
</body>
</html>
